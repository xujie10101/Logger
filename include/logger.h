...
#ifdef NBLH_EXPORTS
#define NBLH_CLASS DLL_EXPORT_CLASS_DECL
#define NBLH_API DLL_EXPORT_DECL
#else
#define NBLH_CLASS DLL_IMPORT_CLASS_DECL
#define NBLH_API DLL_IMPORT_DECL
#endif

namespace toolkit {

class LogContext;
class NBLH_CLASS LogChannel;
class  LogWriter;
class NBLH_CLASS Logger;
...
Logger NBLH_CLASS  &getLogger();
void setLogger(Logger *logger);

/**
* 日志类
*/
class NBLH_CLASS  Logger : public std::enable_shared_from_this<Logger>, public noncopyable {
public:
...
class NBLH_CLASS AsyncLogWriter : public LogWriter {
public:
    AsyncLogWriter();
    ~AsyncLogWriter();
 ...
 */
class NBLH_CLASS ConsoleChannel : public LogChannel {
public:
 ...
 * 输出日志至文件
 */
class NBLH_CLASS FileChannelBase : public LogChannel {
public:
 ...
 * 默认最多保存30天的日志
 */
class NBLH_CLASS FileChannel : public FileChannelBase {
public:
...
class NBLH_CLASS LoggerWrapper {
public:
